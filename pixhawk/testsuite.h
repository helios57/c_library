...
static void mavlink_test_d3_target(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_d3_target_t packet_in = {
		93372036854775807ULL,73.0,101.0
    };
	mavlink_d3_target_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.timestamp = packet_in.timestamp;
        	packet1.x = packet_in.x;
        	packet1.y = packet_in.y;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_target_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_d3_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_target_pack(system_id, component_id, &msg , packet1.timestamp , packet1.x , packet1.y );
	mavlink_msg_d3_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_target_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.x , packet1.y );
	mavlink_msg_d3_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_d3_target_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_target_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.x , packet1.y );
	mavlink_msg_d3_target_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_d3_flow(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_d3_flow_t packet_in = {
		93372036854775807ULL,93372036854776311ULL,129.0,157.0
    };
	mavlink_d3_flow_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.timestamp_from = packet_in.timestamp_from;
        	packet1.timestamp_to = packet_in.timestamp_to;
        	packet1.x = packet_in.x;
        	packet1.y = packet_in.y;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_flow_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_d3_flow_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_flow_pack(system_id, component_id, &msg , packet1.timestamp_from , packet1.timestamp_to , packet1.x , packet1.y );
	mavlink_msg_d3_flow_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_flow_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp_from , packet1.timestamp_to , packet1.x , packet1.y );
	mavlink_msg_d3_flow_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_d3_flow_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_flow_send(MAVLINK_COMM_1 , packet1.timestamp_from , packet1.timestamp_to , packet1.x , packet1.y );
	mavlink_msg_d3_flow_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_d3_pitchroll(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_d3_pitchroll_t packet_in = {
		93372036854775807ULL,73.0,101.0
    };
	mavlink_d3_pitchroll_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.timestamp = packet_in.timestamp;
        	packet1.pitch = packet_in.pitch;
        	packet1.roll = packet_in.roll;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_pitchroll_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_d3_pitchroll_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_pitchroll_pack(system_id, component_id, &msg , packet1.timestamp , packet1.pitch , packet1.roll );
	mavlink_msg_d3_pitchroll_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_pitchroll_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.pitch , packet1.roll );
	mavlink_msg_d3_pitchroll_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_d3_pitchroll_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_d3_pitchroll_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.pitch , packet1.roll );
	mavlink_msg_d3_pitchroll_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
